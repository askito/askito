  ...
  module AirBudd
    ...
    class FormBuilder < ActionView::Helpers::FormBuilder
      ...
      %w( text_field text_area password_field file_field
          date_select time_select datetime_select country_select ).each do |name|
      ...
      def button(purpose = :save, options = {}, html_options = {})
        ...
        element, icon, nature = case purpose
                                ...
                                when :export then [:button, 'table_save', 'positive']
                                end
      ...
      def method_missing(*args, &block)
        if args.first.to_s =~ /^(new|save|cancel|edit|delete|export)$/
